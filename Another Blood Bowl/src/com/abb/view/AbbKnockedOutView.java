 ...
 *
 */
public class AbbKnockedOutView extends JPanel 
{
	...
	public AbbKnockedOutView(AbbAbstractControler controler)
	{
	...
	{     	
        ...
        {        	
        	for (int i=0;i<LENGHT;i++)
        	{
        		...
        		if (id < model.getKnockedOut().size())
        		{
        			txt += model.getKnockedOut().get(id).getNumber();
        			col = Color.ORANGE;
        		}
